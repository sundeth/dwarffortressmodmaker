...
public class Constants {
    ...
    public static final String LOCAL_MODS_FOLDER = "//data//installed_mods";
    
    public static final String OBJECTS_FOLDER = "//objects";
    public static final String GRAPHICS_FOLDER = "//graphics";
    public static final String IMAGES_FOLDER = "//graphics//images";
    public static final String STEAM_PREVIEW_IMAGE = "preview.png";
